...
public class SandboxListas
{
    ...
    public int[] getEnterosComoArreglo( )
    {
    	...
    	{
    		newArray = new int[listaEnteros.size()];
        	
        	for(int i = 0; i < listaEnteros.size(); i++)
        	{
        		newArray[i] = listaEnteros.get(i);
        	}
    	}
    ...
    {
    	if (posicion < listaEnteros.size() && listaEnteros.size() > 0)
    	{
    ...
    public void volverPositivos( )
    {
    	if (listaEnteros.size() > 0)
    	{
    		...
    		for(int i = 0; i < listaEnteros.size(); i++)
        	{
        		n = listaEnteros.get(i);
        		if (n < 0)
        			n *= -1;
        		
        		listaEnteros.add(i, n);
        	}
    	}
    }
    ...
    public boolean compararArregloEnteros( int[] otroArreglo )
    {
    	...
    	if (listaEnteros.equals(Arrays.asList(otroArreglo)))
    		same = true;
